...
function writeCurrenciesDropDown(dropdownTo, dropdownFrom) {
  let htmlTo = '';
  let htmlFrom = '';
...
$(document).ready(function() {
  ...
  writeRates($('#rates'),children.val(),children.val(), 0.00, 0.00);
  ...
  $('#result').change(function () {
    ...
    writeRates($('#rates'),countryFrom,countryTo, conversionAmount, amount);
  });
});